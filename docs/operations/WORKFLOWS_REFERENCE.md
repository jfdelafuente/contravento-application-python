...
graph LR
    ...
    D -->|Auto trigger| F[build-staging-image.yml]
    E -->|Tests OK| G[✅ Quality Gates Pass]
    F -->|Build OK| H[📦 Staging Images in Docker Hub]
...
graph LR
    ...
    B -->|Merge| C[ci.yml]
    B -->|Auto trigger| D[build-production-image.yml]
    C -->|Tests OK| E[✅ Quality Gates Pass]
    D -->|Build OK| F[📦 Production Images + Release]
