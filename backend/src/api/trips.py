...
# Note: GPX endpoints have been moved to src/api/gpx_routes.py (Feature 003)
# This reduces file size from 2487 lines to ~1089 lines for better maintainability.
